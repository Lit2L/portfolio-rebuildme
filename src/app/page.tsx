	...
	return (
		<Container>
			...
			<Paragraph className='max-w-xl mt-4'>
				I&apos;m a full-stack developer that loves <Highlight>building products</Highlight> and web
				apps that can impact millions of lives
			</Paragraph>
			<Paragraph className='max-w-xl mt-4'>
				I&apos;m a senior software engineer with <Highlight>7 years of experience</Highlight>{' '}
