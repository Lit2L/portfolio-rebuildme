...
export const Hero = () => {
	...
	return (
		<header
			id='intro'
			className='pt-20 pb-6 shadow-[inset_0_-40px_15px_-10px_#ededed] transition duration-300 ease-in-out dark:shadow-[inset_0_-40px_15px_-10px_#171717] md:bg-auto w-full'
		>
			<div className='flex md:flex-row flex-col w-full'>
				...
				>
					...
					<div className='h-full w-full rounded-2xl md:hidden dark:bg-zinc-900 md:rounded-2xl md:p-4 '>
						<NavbarDemo />
					</div>
				</motion.section>
			</div>
