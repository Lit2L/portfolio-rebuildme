						...
						{items.map((item, idx) => (
							...
							>
								<Link
									href={item.href}
									key={item.title}
									className='h-10 w-10 rounded-full bg-gray-500 dark:bg-neutral-900 flex items-center justify-center z-50'
								>
...
const FloatingDockDesktop = ({
	...
	return (
		<motion.div
			...
			className={cn(
				'mx-auto hidden md:flex uppercase h-16 gap-4 items-end font-bold rounded-2xl bg-gray-50/10 dark:bg-neutral-900 px-4 pb-3',
				className
			)}
		>
			{items.map((item) => (
