...
export function AnimatedBeamDemo() {
	...
	return (
		<div
			className='relative flex h-full scale-75 w-[50rem] items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl'
			ref={containerRef}
		>
			<div className='flex size-full flex-col max-w-lg max-h-[500px] items-stretch justify-between gap-10'>
